 ...
 */
function skeleton_filter_wp_title( $title, $separator ) {
	...
	if ( is_search() ) {
		...
		$title = sprintf( __( 'Search results for %s', 'skeleton' ), '"' . get_search_query() . '"' );
		// Add a page number if we're on page 2 or more:
		if ( $paged >= 2 )
			$title .= " $separator " . sprintf( __( 'Page %s', 'skeleton' ), $paged );
	...
	if ( $paged >= 2 || $page >= 2 )
		$title .= " $separator " . sprintf( __( 'Page %s', 'skeleton' ), max( $paged, $page ) );

	// Return the new title to wp_title():
	return $title;
}
add_filter( 'wp_title', 'skeleton_filter_wp_title', 10, 2 );
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-meta commentmetadata">
			<?php
				...
				printf( __( '%1$s', 'skeleton' ), get_comment_date(),  get_comment_time() ); ?><?php edit_comment_link( __( '(Edit)', 'skeleton' ), ' ' );
			?>
...
function skeleton_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Footer: Social Media', 'skeleton' ),
	...
	register_sidebar( array(
		'name' => __( 'Footer: Instagram Feed', 'skeleton' ),
	...
	register_sidebar( array(
		'name' => __( 'Footer: Contact Information', 'skeleton' ),
	...
	register_sidebar( array(
		'name' => __( 'Home Page: About Us', 'skeleton' ),
		'id' => 'first-homepage-widget-area',
		'description' => __( 'The first homepage widget area', 'skeleton' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Home Page: Recent Blog Posts', 'skeleton' ),
		'id' => 'second-homepage-widget-area',
		'description' => __( 'The second homepage widget area', 'skeleton' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	// Area 7, located in the homepage. Empty by default.
	register_sidebar( array(
		'name' => __( 'Home Page: Jobs', 'skeleton' ),
		'id' => 'third-homepage-widget-area',
		'description' => __( 'The third homepage widget area', 'skeleton' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
