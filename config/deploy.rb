...
set :beta_server, "beta.cobblehilldigital.com"
set :beta_path, "/var/www/apps/cobblehilldigital_beta/"
set :beta_branch, "master"

# production server settings
set :production_server, "198.61.229.81"
set :production_path, "/var/www/apps/cobblehilldigital/"
set :production_branch, "master"

# repository settings
set :repository, "git@machine.github.com:cobblehillmachine/cobblehilldigital.git"
